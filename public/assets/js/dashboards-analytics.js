...
(function () {
  ...
  const weeklyOverviewChartEl = document.querySelector('#weeklyOverviewChart'),
    weeklyOverviewChartConfig = {
      ...
      series: [
        {
          name: 'Sales',
          data: [5, 9, 2, 3, 2] // Pastikan data ini sesuai dengan MMI
        }
      ],
      colors: [chartBgColor],
      plotOptions: {
      ...
      xaxis: {
        ...
        categories: ['23 May', 'Tue', 'Wed', 'Thu', 'Fri', 'Sat', 'Sun'],
        tickPlacement: 'on',
        labels: {
          show: false
        }
      ...
      yaxis: {
        ...
        labels: {
          formatter: function (val) {
            return val + ' MMI'; // Format dalam MMI
          },
          style: {
            fontSize: '13px',
            fontFamily: 'Inter',
  ...
  const totalProfitLineChartEl = document.querySelector('#totalProfitLineChart'),
    totalProfitLineChartConfig = {
      ...
      series: [
        {
          data: [0, 20, 5, 30, 15, 45] // Pastikan data ini sesuai dengan MMI
        }
      ],
      tooltip: {
        shared: false,
  ...
  const sessionsColumnChartEl = document.querySelector('#sessionsColumnChart'),
    sessionsColumnChartConfig = {
      ...
      plotOptions: {
        bar: {
          ...
          colors: {
            ...
            backgroundBarColors: [chartBgColor],
      ...
      series: [
        {
          data: [30, 70, 50, 40, 60] // Pastikan data ini sesuai dengan MMI
        }
      ],
      responsive: [
        {
  ...
  if (sessionsColumnChartEl !== undefined && sessionsColumnChartEl !== null) {
